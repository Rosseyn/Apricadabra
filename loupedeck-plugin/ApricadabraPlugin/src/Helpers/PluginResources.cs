namespace Loupedeck.ApricadabraPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.ApricadabraPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.ApricadabraPlugin.Resources.Resource.txt`.
